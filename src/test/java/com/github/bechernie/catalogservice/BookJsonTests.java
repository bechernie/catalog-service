...
public class BookJsonTests {
    ...
    void testSerialize() throws Exception {
        ...
        final var book = new Book(394L, "1234567890", "Title", "Author", 9.90, "Polarsophia", now, now, "jenny", "eline", 21);
    ...
    void testDeserialize() throws Exception {
        final var instant = Instant.parse("2021-09-07T22:50:37.135029Z");
        final var content = """
                {
                    "id": 394,
                    "isbn": "1234567890",
