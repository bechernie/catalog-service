...
class BookJsonTests {
    ...
    void testSerialize() throws IOException {
        final var book = new Book(1L, "1234567890", "Title", "Author", 9.9, Instant.parse("2007-12-03T10:15:30.00Z"), Instant.parse("2007-12-03T10:15:30.00Z"), 0);
    ...
    void testDeserialize() throws IOException {
        final var content = """
                ...
                """;
        assertThat(json.parse(content).getObject()).usingRecursiveComparison().isEqualTo(new Book(1L, "1234567890", "Title", "Author", 9.9, Instant.parse("2007-12-03T10:15:30.00Z"), Instant.parse("2007-12-03T10:15:30.00Z"), 0));
    }
}
